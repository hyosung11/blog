...
Post.create({
  ...
  "image" => "http://www.photofromtheworld.com/img/Photo/People/Celebrities/Woman%20Celebrities/Woman%20sports/Serena%20Williams/Serena%20Williams%2010.jpg",
  "body" => "I really think a champion is defined not by their wins but by how they can recover when they fall."
})
...
Post.create({
  "name" => "Simone Biles",
  "image" => "https://i0.wp.com/saintpetersblog.com/wp-content/uploads/2016/08/Simone-Biles.jpg?w=429",
  "body" => "I'd rather regret the risks that didn't work out than the chances I didn't take at all."
})
...
Post.create({
  "name" => "Saquon Barkley",
  "image" => "https://upl.stack.com/wp-content/uploads/2017/06/30121813/Saquon-Barkley-40-STACK.png",
  "body" => "Nothing is given to you. Everything is earned. You have to have that mindset that you have to work every single day. Learn every single day."
})

Post.create({
  "name" => "Chloe Kim",
  "image" => "https://mondrian.mashable.com/uploads%252Fcard%252Fimage%252F712956%252F2fcc9e23-ec6a-4218-82b2-7c1c6f9be63e.jpg%252F950x534__filters%253Aquality%252880%2529.jpg?signature=AkPo7XqrIQMBNRUgtzm8qTvoRb4=&source=https%3A%2F%2Fblueprint-api-production.s3.amazonaws.com",
  "body" => "The one thing I learned is to just give everything a shot. You don't want to live in regret."
})
